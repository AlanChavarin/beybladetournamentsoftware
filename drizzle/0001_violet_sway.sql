...
ALTER TABLE "beybladetournamentsoftware_event" ADD COLUMN "format" varchar(256);--> statement-breakpoint
ALTER TABLE "beybladetournamentsoftware_event" ADD COLUMN "players" varchar(256);--> statement-breakpoint
ALTER TABLE "beybladetournamentsoftware_event" ADD COLUMN "groups" varchar(2);--> statement-breakpoint
DO $$ BEGIN
